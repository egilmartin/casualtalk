...
#
# Prerequisites:
# Exactly one TextGrid object containing 1-5 tiers with labeled intervals must be selected 
...
#
# Up to FIVE speakers and TextGrid tiers are currently supported.
#
